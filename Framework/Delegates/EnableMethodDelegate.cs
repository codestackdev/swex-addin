...
namespace CodeStack.SwEx.AddIn.Delegates
{
    ...
    /// <remarks>State passed to this method is already assigned based on the value of <see cref="Attributes.CommandItemInfoAttribute.SupportedWorkspaces"/> options,
